...
(function () {
  ...
  const dict = {
    en: {
      ...
      'placeholder.tip': 'Currently Phase 5. The regex engine and the Single / Multiline / Filenames / Replace / Split / Capture / Compare modes are ready; the remaining modes will be added in later phases.',
    ...
    zh: {
      ...
      'placeholder.tip': '当前为 Phase 5，已接入正则引擎与 单句 / 多行 / 文件名 / 替换 / 分割 / 捕获组 / 批量对比 模式，其余模式会在后续阶段逐个接入。',
