...
> 进度：Phase 1–8 已完成。下一步是 Phase 9（导出 + 代码生成 + 匹配详情）。顶栏版本号 `v0.8 · Phase 8`。
...
> 进度标记：Phase 2 / 3 / 4 / 5 / 6 / 7 / 8 已完成 ✅；下一步是 Phase 9（导出 + 匹配详情）。下面的验收清单保留作为各阶段的规格说明与回归参考。
...
3. **第三步**：从下一个未完成阶段开始（当前是 **Phase 9**），按本文件 §7 对应阶段的验收清单一条条做
