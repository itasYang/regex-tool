...
> 进度：Phase 1–9 已完成。下一步是 Phase 10（打磨 + v1.0 收尾）。顶栏版本号 `v0.9 · Phase 9`。
...
### 6.2 未实现（占位状态） ❌
- 仅剩 Phase 10（主题平滑过渡、收尾打磨、完整快捷键、v1.0 徽章）
...
> 进度标记：Phase 2 / 3 / 4 / 5 / 6 / 7 / 8 / 9 已完成 ✅；下一步是 Phase 10（最终打磨）。下面的验收清单保留作为各阶段的规格说明与回归参考。
...
3. **第三步**：从下一个未完成阶段开始（当前是 **Phase 10**），按本文件 §7 对应阶段的验收清单一条条做
